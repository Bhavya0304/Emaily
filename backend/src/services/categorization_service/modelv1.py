...
def Categorize(email_data: dict, categories: list, min_threshold: int = 30,user_data = None):
    ...
    try:
        ...
        if(category.lower() != "na"):
            categorize_and_move_email(user_data['access_token'], user_data['message_id'], category)
        return result
